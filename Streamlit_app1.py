...
@st.cache_resource
def load_model():
    model_path = "models/churn_model_bundle.pkl"
    local_path = "c:/Users/HP/Desktop/Strimelit/models/churn_model_bundle.pkl"
    ...
    st.info("Model pickle not found. Training model on the fly... (This takes a few seconds)")
